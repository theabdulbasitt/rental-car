        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              ...
              occasion, providing unparalleled comfort, advanced amenities, and
              a seamless, stylish travel experience with the reliability and
                ...
                <div className="p-8">
                  ...
                  <div className="grid grid-cols-2 gap-6 mb-6">
                    <div className="flex items-center">
                      ...
                      <div>
                        <span className="golden-accent font-bold text-lg">
                          {vehicle.passengers}
                        </span>
        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              All our vehicles come equipped with luxury features to ensure your
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center bg-white p-8 rounded-2xl shadow-lg card-hover">
              ...
              <p className="text-gray-600">
                Stay connected with high-speed internet in all vehicles
              </p>
            </div>
            <div className="text-center bg-white p-8 rounded-2xl shadow-lg card-hover">
              ...
              <p className="text-gray-600">
                High-quality audio systems for your entertainment
              </p>
            </div>
            <div className="text-center bg-white p-8 rounded-2xl shadow-lg card-hover">
            ...
            <div className="text-center bg-white p-8 rounded-2xl shadow-lg card-hover">
              ...
              <p className="text-gray-600">
                Experienced chauffeurs trained in hospitality
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding bg-black">
        <div className="container-custom text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-3xl mx-auto">
            Choose from our diverse selection of luxury vehicles and book your
            premium transportation today.
          </p>
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            ...
            <a
              href="tel:+14438006300"
              className="bg-white text-black hover:bg-gray-100 font-semibold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg text-xl">
              Call (443) 800-6300
            </a>
          </div>
        </div>
