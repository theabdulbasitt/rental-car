...
interface RideServiceLayoutProps {
  heroImage: string;
  heroTitle: string;
  heroSubtitle: string;
  vehicles: Vehicle[];
...
export default function RideServiceLayout({
  heroImage,
  heroTitle,
  heroSubtitle,
  vehicles,
  children,
}: RideServiceLayoutProps) {
  return (
    <>
      {/* Hero Section */}
      ...
      <main className="min-h-screen bg-white py-8 px-2 md:px-8">
        ...
        <div className="max-w-3xl mx-auto mt-16">
          <NeedHelpBooking phone="+1 (443) 336-3333" bookingUrl="/booking" />
        </div>
        {/* Fleet Section */}
